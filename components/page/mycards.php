<link rel="stylesheet" href="http://localhost/CCShop/components/style/mycards.css">
<div class="__mycrds-vw_wrpr">
    <div class="__mycrds-vw_ttl">
        <span>My Cards</span>
    </div>
    <div class="__mycrds-vw_cntnr">
        <div class="__mycards-lst_ttl">
            <div class="__mycards-lst_ttl-icn_wrpr">
                <i class="fa-solid fa-credit-card"></i>
            </div>
            <span>My Cards</span>
        </div>
        <div class="__mycards-lst-itms_wrpr">
            <div class="__mycards-lst-itm">
                <div class="card">
                    <div class="flip">
                        <div class="front">
                            ...
                            <div class="card-number">
                                <div class="section">4943</div>
                                <div class="section">1414</div>
                                <div class="section">3718</div>
                                <div class="section">9883</div>
                            </div>
                            <div class="end">
                                <span class="end-text">exp. end:</span>
                                <span class="end-date"> 12/25</span>
                            </div>
                            <div class="card-holder">mr Mitnick Vitas</div>
                        </div>
                        <div class="back">
